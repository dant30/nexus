  ...
  return (
    <Card>
      <div className="mb-3 flex items-center justify-between">
        <div className="text-sm font-semibold text-white/80">Win vs Loss</div>
        <div className="text-xs text-white/50">{total} total</div>
      </div>

      {total === 0 ? (
        <p className="text-xs text-white/55">No closed trades yet.</p>
      ) : (
        <>
          ...
          <div className="mt-3 grid grid-cols-2 gap-2 text-xs">
            <div className="rounded bg-emerald-400/10 p-2 text-emerald-300">
              ...
              <p className="text-[11px] text-emerald-200/70">{winsPct.toFixed(1)}%</p>
            </div>
            <div className="rounded bg-rose-400/10 p-2 text-rose-300">
              ...
              <p className="text-[11px] text-rose-200/70">{lossesPct.toFixed(1)}%</p>
            </div>
          </div>
        </>
      )}
